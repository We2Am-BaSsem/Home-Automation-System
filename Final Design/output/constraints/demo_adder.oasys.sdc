...
set_input_delay 0.3 [get_ports Clk]
set_input_delay 0.3 [get_ports Rst]
set_input_delay 0.3 [get_ports SFD]
set_input_delay 0.3 [get_ports SRD]
set_input_delay 0.3 [get_ports SW]
set_input_delay 0.3 [get_ports SFA]
set_input_delay 0.3 [get_ports {ST[6]}]
set_input_delay 0.3 [get_ports {ST[5]}]
set_input_delay 0.3 [get_ports {ST[4]}]
set_input_delay 0.3 [get_ports {ST[3]}]
set_input_delay 0.3 [get_ports {ST[2]}]
set_input_delay 0.3 [get_ports {ST[1]}]
set_input_delay 0.3 [get_ports {ST[0]}]
